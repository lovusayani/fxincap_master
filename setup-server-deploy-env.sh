...
echo "  - VITE_API_URL         (e.g. https://api.ncapfx.com — no trailing slash)"
echo ""
echo "Then:  bash ${ROOT}/run-prod.sh"
echo "GitHub: use the EXISTING webhook https://ncapfx.com/hooks/deploy — ensure DEPLOY_WEBHOOK_SECRET matches; do not add a second webhook."
