...
const  SuimfxWordmark = ({ appName, ...props }: SVGProps<SVGSVGElement> & { appName: string }) => (
  <svg
    aria-label={`${appName} Wordmark`}
    role="img"
    viewBox="0 0 120 35"
    fill="currentColor"
    {...props}
  >
    <text x="0" y="25" fontSize="24" fontWeight="bold" fontFamily="sans-serif">{appName}</text>
  </svg>
);
                    ...
                    <div className="flex h-full flex-col bg-gradient-to-b from-black/60 to-black/30">
                        <div className="flex-grow px-6 py-16 sm:px-12 lg:pl-20 xl:pl-28 lg:pr-12 lg:py-24">
                            <div className="max-w-md">
                                < SuimfxWordmark appName={appName} className="h-8 w-auto mb-4" />
                                <h1 className="font-headline text-[48px] lg:text-[56px] font-light leading-none mb-6">
                                    White-Label Solutions
                                </h1>
                                <p className="text-lg leading-relaxed mb-6">
                                    Launch your own forex brokerage with {appName} White Label — complete with:
                                </p>
