      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-900 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-black px-8 py-10 text-center">
            ...
            <p className="text-slate-400 text-sm">Enter your detail to Create your account today</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-start gap-2">
                <input
                  ...
                  onChange={handleChange}
                  className="mt-1 w-4 h-4 bg-slate-800 border-slate-600 rounded text-purple-500 focus:ring-purple-500 focus:ring-offset-0"
                />
